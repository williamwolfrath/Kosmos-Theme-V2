...
<script type="text/javascript">
 ...
 <input type="text" maxlength="128" name="search_block_form" id="edit-search-block-form-1" size="15" value="Search" class="form-text NormalTextBox txtSearch"
        onfocus="if (this.value == 'Search') {this.value = '';}"
        onblur="if (this.value == '') {this.value = 'Search';}" />
 <input type="image" name="op" value="Search" id="edit-submit-2"  class="form-submit" src="/sites/all/themes/SpontaneousAcademia/images/search-box-right.gif" />
<input type="hidden" name="form_build_id" id="form-<?php print md5(uniqid(mt_rand(), true)); ?>" value="form-<?php print md5(uniqid(mt_rand(), true)); ?>" /> 
